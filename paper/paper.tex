...
\usepackage{complexity}                  % \NP
\usepackage[ruled,vlined]{algorithm2e}   % algorithms
\usepackage{booktabs}                    % less ugly tables
\usepackage[tight-spacing=true]{siunitx} % formatting of units
\usepackage{tikz}                        % For pretty pictures
\usepackage{graphicx}                    % For the charts
...
\begin{table}
    ...
    % The following only affects the cmidrules on this table: by default booktabs sticks larger
    % spacing than normal latex tables do above and below mid-table rules. Usually that's fine, but
    % here the table is just slightly too large for the page, and I'd rather not use a smaller font
    % or cut one of the data points. (I suppose the other option would just be to just cut the
    % cmidrules out entirely, and then it fits perfectly...)
...
\begin{figure}[h!] % try to keep this immediately above the next figure
    \centering
    \includegraphics{gen-graph-omega.pdf}
...
\begin{figure}[h!] % try to keep this immediately below the previous figure
    \centering
    \includegraphics{gen-graph-nodes.pdf}
...
\begin{figure}[h!] % try to keep this immediately above the next figure
    \centering
    \includegraphics{gen-graph-omega-2.pdf}
...
\begin{figure}[h!] % try to keep this immediately below the previous figure
    \centering
    \includegraphics{gen-graph-nodes-2.pdf}
